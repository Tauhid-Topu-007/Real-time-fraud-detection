...
class FraudPredictor:
    ...
    def __init__(self, model_path=None):
        # Try multiple paths for cloud and local
        if model_path is None:
            possible_paths = [
                Path("models"),
                Path("../models"),
                Path("../../models"),
                Path("/mount/src/real-time-fraud-detection/models"),
            ...
            if fe_file.exists():
                try:
                    ...
                    if hasattr(self.feature_engineer, 'feature_columns'):
                        ...
                        print("⚠️ feature_engineer.pkl loaded but no feature_columns")
                except Exception as e:
                    print(f"❌ Error loading feature_engineer: {e}")
            else:
                print(f"⚠️ feature_engineer.pkl not found")
    ...
    def prepare_features(self, transaction):
        ...
        try:
            ...
            # ... (rest of manual feature code remains same)
